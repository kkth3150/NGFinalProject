...
enum OBJ_ID {OBJ_BOSS, OBJ_BOSSPART, OBJ_ENEMY_1, OBJ_ENEMY_2,OBJ_PLAYERBULLET,OBJ_BULLET_ENEMY , OBJ_PLAYER1, OBJ_PLAYER2,OBJ_EXPLOSION, OBJ_BUTTON ,OBJ_UI ,OBJ_FINGER ,OBJ_END };
