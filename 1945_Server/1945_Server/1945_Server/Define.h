...
enum OBJ_ID { OBJ_BOSS, OBJ_ENEMY, OBJ_PLAYERBULLET, OBJ_BULLET_ENEMY, OBJ_PLAYER1, OBJ_PLAYER2, OBJ_EXPLOSION, OBJ_BUTTON, OBJ_UI, OBJ_FINGER, OBJ_END };
...
enum RECEIVE_EVENT_TYPE : uint8_t { R_MY_CLIENT_ID, R_PLAYER_CHOICE, R_LEVEL_CHANGE, R_OTHER_PLAYER_MOVE,
	R_MONSTER_GEN,R_BOSS_GEN,R_OBJ_DEAD,R_EVENT_END };
